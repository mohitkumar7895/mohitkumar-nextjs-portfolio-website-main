      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        >
          <motion.div {...fadeInUp}>
            ...
            “I’m always open to exploring new projects, sharing creative ideas, and contributing to opportunities where I can be a part of your vision and add value.”
            </p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <a href="7895094129" className="text-secondary hover:text-primary">
                  +91 7895094129
                </a>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-secondary">Kalindi, Vihar Agra</p>
              </div>
            </motion.div>
          </motion.div>
        </motion.div>
