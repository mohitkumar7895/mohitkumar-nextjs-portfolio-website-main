    ...
    <div className="container max-w-7xl mx-auto py-12">
      ...
      >
        <p className="text-lg text-secondary max-w-3xl mx-auto text-center">
          “I am a MERN Stack Developer with hands-on experience in frontend development through my internship, and I am currently working on and learning backend development to strengthen my skills. I am passionate about building scalable web applications and continuously improving my expertise to deliver better user experiences and efficient solutions.”
        </p>
      </motion.section>
